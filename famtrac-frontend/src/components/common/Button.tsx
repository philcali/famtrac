...
const VARIANT_CLASSES: Record<string, string> = {
  ...
  'outline-secondary':
    'bg-transparent text-gray-600 border border-gray-600 hover:bg-gray-50 active:bg-gray-100',
  'outline-success':
    'bg-transparent text-green-600 border border-green-600 hover:bg-green-50 active:bg-green-100',
  'outline-danger':
    'bg-transparent text-red-600 border border-red-600 hover:bg-red-50 active:bg-red-100',
  'outline-warning':
    'bg-transparent text-yellow-600 border border-yellow-600 hover:bg-yellow-50 active:bg-yellow-100',
  'outline-info':
